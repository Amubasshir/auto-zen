...
import { GitBranch, ExternalLink, Video, FileText, Pencil, Trash2 } from "lucide-react";
...
export function ProjectCard({ project, onDragStart, onEdit, onDelete }: Props) {
  ...
  return (
    <div
      ...
      className="group bg-zen-surface border border-zen-line rounded-[10px] p-3.5 pb-3 flex flex-col gap-2.5 cursor-grab active:cursor-grabbing active:opacity-60 hover:border-zen-line-strong hover:-translate-y-px transition-all duration-150"
    >
      {/* Title + actions */}
